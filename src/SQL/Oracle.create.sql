...
(
	...
	"ДатаДобавления" NVARCHAR2(255) NULL,
...
ALTER TABLE "Опреации"
	ADD CONSTRAINT "Опреации_FПол_4944" FOREIGN KEY ("Админ") REFERENCES "Пользователь" ("primaryKey");

CREATE INDEX "Опреации_IАдмин" on "Опреации" ("Админ");

ALTER TABLE "Опреации"
	ADD CONSTRAINT "Опреации_FОбо_4849" FOREIGN KEY ("Оборудование") REFERENCES "Оборудование" ("primaryKey");

CREATE INDEX "Опреации_IОбо_9920" on "Опреации" ("Оборудование");
