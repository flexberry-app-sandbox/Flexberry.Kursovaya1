...
namespace IIS.Kursovaya1
{
    ...
    public class РабочееМесто : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya1.Филиал fФилиал;
        
        private IIS.Kursovaya1.DetailArrayOfПО fПО;
        ...
        [PropertyStorage(new string[] {
                "Филиал"})]
        [NotNull()]
        public virtual IIS.Kursovaya1.Филиал Филиал
        {
            get
            {
                ...
                IIS.Kursovaya1.Филиал result = this.fФилиал;
        ...
        public virtual IIS.Kursovaya1.DetailArrayOfПО ПО
        {
            get
            {
                ...
                if ((this.fПО == null))
                {
                    this.fПО = new IIS.Kursovaya1.DetailArrayOfПО(this);
                }
                IIS.Kursovaya1.DetailArrayOfПО result = this.fПО;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РабочееМестоE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РабочееМестоE", typeof(IIS.Kursovaya1.РабочееМесто));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РабочееМестоL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РабочееМестоL", typeof(IIS.Kursovaya1.РабочееМесто));
                }
            }
        }
    }
